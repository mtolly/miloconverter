...
public class GClass11
{
	...
	public int method_3(GClass12 gclass12_0, int int_2)
	{
		int_2 = Math.Min(Math.Min(int_2, 32768 - this.int_1), gclass12_0.method_3());
		int num = 32768 - this.int_0;
		int num2;
		if (int_2 > num)
		{
			num2 = gclass12_0.method_6(this.byte_0, this.int_0, num);
			if (num2 == num)
			{
				num2 += gclass12_0.method_6(this.byte_0, 0, int_2 - num);
			}
		}
		else
		{
			num2 = gclass12_0.method_6(this.byte_0, this.int_0, int_2);
		}
